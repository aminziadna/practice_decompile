...
/* compiled from: SellCanceledController.kt */
public final class SellCanceledController extends BaseController {
    private int clickedViewId;
    @BindView
    public Toolbar toolbar;

    /* compiled from: SellCanceledController.kt */
    /* renamed from: ru.gg.scooby.ui.controller.SellCanceledController$a */
    static final class C4655a extends C3038k implements C0690b<C2342r<Void>, C0727n> {
        final /* synthetic */ SellCanceledController this$0;

        C4655a(SellCanceledController sellCanceledController) {
            this.this$0 = sellCanceledController;
            super(1);
        }

        /* renamed from: a */
        public final void m20561a(C2342r<Void> c2342r) {
    ...
    /* compiled from: SellCanceledController.kt */
    /* renamed from: ru.gg.scooby.ui.controller.SellCanceledController$b */
    static final class C4656b extends C3038k implements C0690b<Throwable, C0727n> {
        final /* synthetic */ SellCanceledController this$0;

        C4656b(SellCanceledController sellCanceledController) {
            this.this$0 = sellCanceledController;
            super(1);
        }

        /* renamed from: a */
        public final void m20563a(Throwable th) {
            C0700j.m2715b(th, "it");
            ControllerExKt.hideProgress$default(this.this$0, null, 1, null);
    ...
    protected View inflateView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        Object inflate = layoutInflater.inflate(R.layout.controller_sell_canceled, viewGroup, false);
        ...
        if (view != null) {
            ...
            if (view != null) {
                ...
                if (view != null) {
                    ...
                    C2517a.m10349a(a, (C0690b) new C4656b(this), null, (C0690b) new C4655a(this), 2, null);
                }
            }
        }
    }
